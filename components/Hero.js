...
//       {/* 1. BACKGROUND SLIDESHOW (Unchanged) */}
//       <div className="absolute inset-0">
//         {backgroundImages.map((image, index) => (
//           <div
//             key={index}
...
//       {/* 3. MAIN CONTENT CONTAINER - THE "FREEDOM" LAYOUT */}
//       <div className="relative z-10 container-custom px-4 sm:px-6 lg:px-8 h-screen lg:h-auto pt-28 pb-8 lg:py-0 flex flex-col justify-between lg:block">
        
//         <div className="max-w-4xl mx-auto text-center flex flex-col h-full lg:block">

//           {/* === TOP SLOT: BADGE === */}
//           <div className="flex justify-center lg:block lg:mb-6">
...
//           {/* === MIDDLE SLOT: TEXT & BUTTONS === 
//               flex-1 ensures this section takes up all remaining space in the middle
//           */}
//           <div className="flex-1 flex flex-col justify-center lg:block lg:flex-none">
...
//             {/* CTA Buttons */}
//             <div className="hero-cta flex flex-col sm:flex-row items-center justify-center gap-4 mb-4 lg:mb-12">
//               <Link
//                 href="/products"
//                 className="group bg-gradient-to-r from-accent-purple to-accent-pink hover:from-accent-pink hover:to-accent-purple text-white font-semibold text-lg px-8 py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-2xl shadow-accent-purple/25 flex items-center space-x-3 w-full sm:w-auto justify-center"
//               >
//                 <span>Explore Collection</span>
//                 <FiArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
//               </Link>
//               <Link
//                 href="/products?filter=limited"
//                 className="group border-2 border-white/20 hover:border-accent-cyan bg-white/5 backdrop-blur-sm hover:bg-accent-cyan/10 text-white font-semibold text-lg px-8 py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 w-full sm:w-auto justify-center"
//               >
//                 <FiStar className="w-5 h-5 text-accent-cyan" />
//                 <span>Limited Editions</span>
//               </Link>
...
//             <div className="stats-container grid grid-cols-3 gap-4 lg:flex lg:justify-center lg:gap-12">
//               <div className="stat-card">
//                 <span className="stat-icon block text-2xl mb-1 lg:inline lg:text-base lg:mb-0 lg:mr-2">👥</span>
//                 <span className="stat-number block font-bold text-xl lg:inline lg:text-base">5K+</span>
...
//       {/* Scroll indicator - Hidden on mobile to avoid clutter since stats are at bottom */}
